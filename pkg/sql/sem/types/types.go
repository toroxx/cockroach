...
// MakeCollatedString constructs a new instance of a STRING datatype with OID
// T_text and the given width.
func MakeCollatedString(locale string, width int32) *T {
	return &T{SemanticType: COLLATEDSTRING, Width: width, Locale: &locale}
}

// MakeCollatedVarChar constructs a new instance of a STRING datatype with OID
// T_varchar and the given width.
func MakeCollatedVarChar(locale string, width int32) *T {
	return &T{
		SemanticType: COLLATEDSTRING,
		Width:        width,
		Locale:       &locale,
		ZZZ_Oid:      oid.T_varchar,
	}
}

// MakeCollatedChar constructs a new instance of a STRING datatype with OID
// T_bpchar and the given width.
func MakeCollatedChar(locale string, width int32) *T {
	return &T{
		SemanticType: COLLATEDSTRING,
		Width:        width,
		Locale:       &locale,
		ZZZ_Oid:      oid.T_bpchar,
	}
}
